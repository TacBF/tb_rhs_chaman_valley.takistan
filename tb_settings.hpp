  ...
  class zones
  {
	...
	class mission
	{
		...
		class factions // or sides
		{
            ...
            class teamFlag
            {
                bluFor = "flags\houthi.jpg"; // "flags" is a sub-folder in mission folder
                opFor = "flags\saudi.jpg";
            };
		};
		class scoring
		{
...
#define __unlimited -99
            kits[] =
            {
                // BLUFOR or ALL factions
                {
                    ...
                    {__ICE_gear_Grenadier, "Grenadier", 5, 1, 0, 3},
                    ...
                    {__ICE_gear_HeavyAT, "Heavy AT", 5, 0},
                    ...
                    {__ICE_gear_Diver, "Mujahedin", 10, 0, 0, 2}
                },
